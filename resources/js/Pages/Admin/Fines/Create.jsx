                        ...
                        <div className="rounded-lg px-4 py-6">
                            <dl className="flex flex-col gap-x-12 gap-y-4 text-sm leading-relaxed text-foreground lg:flex-row">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <dd>{formatToRupiah(props.return_book.fine?.total_fee ?? 0)}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                    ...
                    <Table className="mt-6 w-full">
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell>
                                    {formatToRupiah(props.return_book.fine?.late_fee ?? 0)}
                                    <span className="text-red-500">({props.return_book.dayslate ?? 0})</span>
                                </TableCell>

                                <TableCell>
                                    {formatToRupiah(props.return_book.fine?.other_fee ?? 0)}
                                    <span className="text-red-500">
                                        ({props.return_book.return_book_check?.condition ?? '-'})
                                    </span>
                                </TableCell>

                                <TableCell>{formatToRupiah(props.return_book.fine?.total_fee ?? 0)}</TableCell>
