            ...
            <Card>
                ...
                <CardContent>
                    <form className="space-y-6" onSubmit={onHandleSubmit}>
                        ...
                        <div className="grid w-full items-center gap-1.5">
                            <Label htmlFor="loan_code">Batas Pengembalian</Label>
                            <Input
                                name="due_date"
                                id="due_date"
                                type="date"
                        ...
                        <div className="grid w-full items-center gap-1.5">
                            <Label htmlFor="loan_code">Tanggal Pengembalian</Label>
                            <Input
                                name="return_date"
                                id="return_date"
                                type="date"
                            ...
                            >
                                ...
                                <SelectContent>
                                    {props.conditions.map((condition, index) => (
                                        <SelectItem
                                            key={index}
                                            value={condition.value.toString()} // Pastikan value berupa string
                                        >
                                            {condition.label}
                                        </SelectItem>
                                    ))}
