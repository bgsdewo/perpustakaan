...
class LoanStatisticController extends Controller
{
    ...
    {
        return inertia('Admin/LoanStatistics/Index', props: [
            'page_settings' => [
                'title' => 'Statistik Peminjaman',
                'subtitle' => 'Menampilkan statistik peminjaman yang tersedia pada platform ini',
            ],
            'page_data' => [
                'least_loan_books' => LoanStatisticResource::collection(resource: Book::leastLoanBooks(5)),
                'most_loan_books' => LoanStatisticResource::collection(resource: Book::mostLoanBooks(5)),
